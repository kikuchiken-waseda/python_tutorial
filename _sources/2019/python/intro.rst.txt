...
そう，なんでもできるのです
（筆者は，ターミナルと chrome 以外のアプリケーションを開くことは滅多にありません）．
...
今回使用する鉛筆の名前は :code:`vim` といいます.

取り出し方は簡単です．
ただ，ターミナルに :code:`vim` と入力してください．

.. note:: emacs 派の方はどうぞそれで. 戦争をする気はありません．
...
.. warning:: version はきちんと確認をしてください.

   ヘビが大きくなっていませんか? つまり, ANACONDA とか書いていませんか?
   なっている場合今は良いですが後で困るかもです
...
これをうまく使って，好きな大きさのクリスマスツリーを書く python スクリプトを作成してみてください．
